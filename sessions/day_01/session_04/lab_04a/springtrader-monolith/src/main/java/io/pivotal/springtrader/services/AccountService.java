...
import io.pivotal.springtrader.exceptions.AuthenticationException;
import io.pivotal.springtrader.exceptions.NoRecordsFoundException;
import io.pivotal.springtrader.repositories.AccountRepository;

/**
 * The service in the io.pivotal.springtrader.accountRepository.accountRepository microservice.
 * 
...
public class AccountService {
	...
	/**
	 * The io.pivotal.springtrader.accountRepository.accountRepository repository.
	 */
	@Autowired
